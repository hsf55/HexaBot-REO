...
def _render_login(notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title="HEXACORD Login", body=body, session=None, notice=notice)
...
def _render_guild_picker(session: dict[str, Any], guilds: list[dict[str, Any]], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title="HEXACORD Guilds", body=body, session=session, guilds=guilds, notice=notice)
...
def _render_overview(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], bot_guild, state: dict[str, Any], notice: str | None = None) -> str:
    ...
    <section class="hero">
      <article class="panel">
        ...
        <div class="grid" style="margin-top:18px;">
          ...
          <div class="card"><strong>Subscription</strong><div class="metric">{_escape((guild_state.get('subscription') or 'PREMIUM').replace('_', ' ').title())}</div></div>
    ...
    return _render_layout(
        title=f"HEXACORD Overview - {current_guild['name']}",
        body=body,
        session=session,
        guilds=guilds,
...
def _render_security(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Security - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="security", notice=notice)
...
def _render_moderation(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Moderation - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="moderation", notice=notice)
...
def _render_music(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], bot_guild, state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Music - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="music", notice=notice)
...
def _render_commands(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Commands - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="commands", notice=notice)
...
def _render_logs(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Logs - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="logs", notice=notice)
...
def _render_giveaways(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Giveaways - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="giveaways", notice=notice)
...
def _render_tickets(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Tickets - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="tickets", notice=notice)
...
def _render_welcomer(session: dict[str, Any], guilds: list[dict[str, Any]], current_guild: dict[str, Any], state: dict[str, Any], notice: str | None = None) -> str:
    ...
    """
    return _render_layout(title=f"HEXACORD Welcomer - {current_guild['name']}", body=body, session=session, guilds=guilds, current_guild=current_guild, active_tab="welcomer", notice=notice)
