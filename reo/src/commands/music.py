...
class REOMusicControllerView(discord.ui.LayoutView):
    ...
    def _build(self) -> None:
        ...
        container.add_item(discord.ui.TextDisplay("# HEXACORD Music"))
        ...
        if self.player and self.player.current:
            ...
            container.add_item(
                discord.ui.TextDisplay(
                    "-# Drop a song name in this channel and HEXACORD will start the session."
                )
            )
...
class Music(commands.Cog):
    ...
    async def _validate_controller_interaction(self, interaction: discord.Interaction):
        ...
        if vc.channel != interaction.user.voice.channel:
            ...
            await interaction.response.send_message(
                embed=discord.Embed(
                    description="You need to be in the same voice channel as HEXACORD.",
                    color=color.red,
                ),
                ephemeral=True,
                delete_after=8,
